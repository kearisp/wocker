...
При активації реверс проксі буде запускатися кожного разу при [старті проєкту](/docs/project/management#запуск-проєкту) і зупинятися кожного разу при [зупинці проєкту](/project/management#зупинення-проєкту) автоматично.
